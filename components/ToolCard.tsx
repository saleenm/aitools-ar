...
export default function ToolCard({ tool }: Props) {
  ...
  return (
    <Link href={`/${locale}/tools/${tool.slug}`}
      className="group flex flex-col bg-gray-900/80 border border-gray-800/60 hover:border-violet-500/40 rounded-2xl p-5 tool-glow shine-card">
